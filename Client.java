...
public class Client {
    ...
    public Client() {
        ...
        statLabel2.setBounds(0,330,380,20);
...
//		System.out.println("!!!!!!!!!!!!!!!!!");
                ...
                System.out.println("2 Nothing to read" + iioe.toString());
            }
...
//    public class FFmpegFXImageDecoder extends Application{
//
//	static final int WIDTH = 1296;
//    	static final int HEIGHT = 720;
//	private InputStream inputStream;
//
//	private FFmpegFXImageDecoder(byte[] inputBytes) {
//		System.out.println("FFmpegFXImageDecoder");
...
//    ) {
//        try (
//		//System.out.println("streamToImageView try");
//             final FrameGrabber grabber = new FFmpegFrameGrabber(
//                 inputStream);
//        ) {
//            final Java2DFrameConverter converter = new Java2DFrameConverter();
//            System.out.println("makeconverter");
...
//		System.out.println("In while(!Thread.interrupted");
//                final Frame frame = grabber.grab();
//                if (frame != null) {
//                    final BufferedImage bufferedImage = converter.convert(frame);
//                    if (bufferedImage != null) {
//                        //Platform.runLater(() ->
//                            view.setImage(SwingFXUtils.toFXImage(bufferedImage, null));    //convert bufferedImage to ImageFile
//                    		
//		    }
//                }
//            }
...
//
//	public FFmpegFXImageDecoder dec;
//	public byte[] input;
//	public Stream(byte[] input){
//		this.input = input;
//	}
//	public void run(){
//		System.out.println("Yeah~~~!!!!");
//		dec = new FFmpegFXImageDecoder(this.input).streamToImageView(imageView, 12345, 100, "h264", 96, 25000000, "ultrafast", 0);
//	}
//    }
