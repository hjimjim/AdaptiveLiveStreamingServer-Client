...
public class Server extends JFrame implements ActionListener {
    ...
    public Server() {
        ...
        try {
            outputFile = new File("video_" + fileIndex + ".h264");
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         * if (check_wifi().equals("off/an")) { //string°ªÀÌ ŸÆŽÏ¶ó // timer.stop();

         * System.out.println("hahahahahaahahahahahahahahhahahahahh"); if (!check) { try

         * { System.out.println("nononoo"); video.stopVideo(); video.getStarted(); }

         * catch (Exception e10) {

         * 

         * } } check = true; try { image_length = video.getnextframe(buf); //ÀÌ¹ÌÁö µ¥ÀÌÅÍ

         * ¹ÞŸÆµé¿©Œ­ buf¿¡ ÀúÀå fos2.write(buf, 0, image_length); //fos2¿¡ writeÇÏŽÂµ¥ } catch

         * (Exception e4) { System.out.println("eee"); } // save_video(); return; }else
        ...
        } else { // Å¬¶óÀÌŸðÆ®, Œ­¹ö ¿¬°áµÇŸîÀÖÀ» °æ¿ì
                ...
                try {
                    ...
                    if(checkResult == DISCON) {
                        try {
                            ...
                            System.out.println("File write error: " + fileE);
                        }
                    }
                    ...
                    System.out.println(
                            ...
                            "Send frame #" + imagenb + ", Frame size: " + image_length + " (" + buf.length + ")");
